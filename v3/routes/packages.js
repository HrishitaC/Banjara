                ...
                if(err){
                    ...
                    Hotel.find({}, function(err, allHotels){
                        if(err){
                            ...
                            res.render("packages/new", {spots: foundSpots, tours: allTours, hotels: allHotels});                            
                        }
                    });
                }
            });
...
router.get("/:id", function(req, res){
    Package.findById(req.params.id).populate("spots comments tours hotels").exec(function(err, foundPackage){
        if(err){
            console.log(err);
        } else {
