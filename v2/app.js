...
var spotCommentRoutes   = require("./routes/spotComments"),
    ...
    hotelCommentRoutes   = require("./routes/hotelComments"),
    tourCommentRoutes   = require("./routes/tourComments"),
...
app.use("/tours/:id/comments", tourCommentRoutes);
app.use("/hotels/:id/comments", hotelCommentRoutes);
